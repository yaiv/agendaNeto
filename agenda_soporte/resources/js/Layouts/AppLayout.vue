                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink 
                                    v-if="$page.props.auth.user.is_global_admin || ($page.props.auth.user.current_team && $page.props.auth.user.current_team.user_id === $page.props.auth.user.id)"
                                    :href="route('engineers.index')" 
                                    :active="route().current('engineers.*')"
                                >
                                    Ingenieros
                                </NavLink>
                            </div>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="60" v-if="$page.props.jetstream.hasTeamFeatures">
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            <template v-if="$page.props.auth.user.current_team.user_id === $page.props.auth.user.id || $page.props.auth.user.is_global_admin">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <template v-if="$page.props.jetstream.hasTeamFeatures">
                                ...
                                <!-- Team Management - Solo visible para el propietario del equipo o admin global -->
                                <template v-if="$page.props.auth.user.current_team.user_id === $page.props.auth.user.id || $page.props.auth.user.is_global_admin">
                                    <div class="block px-4 py-2 text-xs text-gray-400">
                                        Manage Team
                                    </div>
